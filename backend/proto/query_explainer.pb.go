...
func (x *GetQueryPlanRequest) GetPeriodStartFrom() *timestamp.Timestamp {
	if x != nil {
...
func (x *GetQueryPlanRequest) GetPeriodStartTo() *timestamp.Timestamp {
	if x != nil {
...
func (x *GetQueryPlanRequest) GetClusterName() string {
	if x != nil {
...
func (x *GetQueryPlanRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *GetQueryPlanRequest) GetParameters() []string {
	if x != nil {
		return x.Parameters
	}
	return nil
...
var file_query_explainer_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9d, 0x02, 0x0a, 0x13, 0x47, 0x65, 0x74,
	...
	0x09, 0x52, 0x07, 0x71, 0x75, 0x65, 0x72, 0x79, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61,
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x61,
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0x50, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x51,
	...
	0x75, 0x65, 0x72, 0x79, 0x5f, 0x70, 0x6c, 0x61, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6c, 0x61, 0x6e, 0x32, 0x95, 0x01, 0x0a, 0x0e, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x45, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x82, 0x01,
	...
	0x01, 0x2a, 0x42, 0x20, 0x5a, 0x1e, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x2d, 0x65,
	0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x70,
...
var file_query_explainer_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_query_explainer_proto_goTypes = []interface{}{
	(*GetQueryPlanRequest)(nil),  // 0: borealis.v1beta1.GetQueryPlanRequest
	(*GetQueryPlanResponse)(nil), // 1: borealis.v1beta1.GetQueryPlanResponse
	(*timestamp.Timestamp)(nil),  // 2: google.protobuf.Timestamp
}
var file_query_explainer_proto_depIdxs = []int32{
	2, // 0: borealis.v1beta1.GetQueryPlanRequest.period_start_from:type_name -> google.protobuf.Timestamp
	2, // 1: borealis.v1beta1.GetQueryPlanRequest.period_start_to:type_name -> google.protobuf.Timestamp
	0, // 2: borealis.v1beta1.QueryExplainer.GetQueryPlan:input_type -> borealis.v1beta1.GetQueryPlanRequest
	1, // 3: borealis.v1beta1.QueryExplainer.GetQueryPlan:output_type -> borealis.v1beta1.GetQueryPlanResponse
